...
namespace {
    auto logger = dht_hunter::logforge::LogForge::getLogger("DHT.ResponseMessage");
}
...
std::shared_ptr<ResponseMessage> ResponseMessage::decode(const bencode::BencodeValue& value) {
    ...
    if (!t) {
        logger->warning("Response has no 't' field");
        return nullptr;
    }
    ...
    auto r = value.get("r");
    if (!r || !r->isDictionary()) {
        logger->warning("Response has no 'r' field or it's not a dictionary");
        return nullptr;
    }
    ...
    if (!id || id->length() != 20) {
        logger->warning("Response has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
...
std::shared_ptr<PingResponse> PingResponse::decode(const bencode::BencodeValue& value) {
    ...
    auto t = value.getString("t");
    if (!t) {
        logger->warning("Ping response has no 't' field");
        return nullptr;
    }
    ...
    auto r = value.get("r");
    if (!r || !r->isDictionary()) {
        logger->warning("Ping response has no 'r' field or it's not a dictionary");
        return nullptr;
    }
    ...
    auto id = r->getString("id");
    if (!id || id->length() != 20) {
        logger->warning("Ping response has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
...
std::shared_ptr<FindNodeResponse> FindNodeResponse::decode(const bencode::BencodeValue& value) {
    ...
    auto t = value.getString("t");
    if (!t) {
        logger->warning("find_node response has no 't' field");
        return nullptr;
    }
    ...
    auto r = value.get("r");
    if (!r || !r->isDictionary()) {
        logger->warning("find_node response has no 'r' field or it's not a dictionary");
        return nullptr;
    }
    ...
    auto id = r->getString("id");
    if (!id || id->length() != 20) {
        logger->warning("find_node response has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
    ...
    if (!nodes) {
        logger->warning("find_node response has no 'nodes' field");
        return nullptr;
    }
...
std::shared_ptr<GetPeersResponse> GetPeersResponse::decode(const bencode::BencodeValue& value) {
    ...
    auto t = value.getString("t");
    if (!t) {
        logger->warning("get_peers response has no 't' field");
        return nullptr;
    }
    ...
    auto r = value.get("r");
    if (!r || !r->isDictionary()) {
        logger->warning("get_peers response has no 'r' field or it's not a dictionary");
        return nullptr;
    }
    ...
    auto id = r->getString("id");
    if (!id || id->length() != 20) {
        logger->warning("get_peers response has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
    ...
    if (!token) {
        logger->warning("get_peers response has no 'token' field");
        return nullptr;
    }
    ...
    if (nodes) {
        ...
        for (const auto& peerValue : values->getList()) {
            if (!peerValue->isString()) {
                logger->warning("Peer value is not a string");
                continue;
            }
            ...
            if (peerInfo.length() != 6) {
                logger->warning("Invalid peer info length: {}", peerInfo.length());
                continue;
            }
        ...
        logger->warning("get_peers response has neither 'nodes' nor 'values' field");
        return nullptr;
    }
}
...
std::shared_ptr<AnnouncePeerResponse> AnnouncePeerResponse::decode(const bencode::BencodeValue& value) {
    ...
    auto t = value.getString("t");
    if (!t) {
        logger->warning("announce_peer response has no 't' field");
        return nullptr;
    }
    ...
    auto r = value.get("r");
    if (!r || !r->isDictionary()) {
        logger->warning("announce_peer response has no 'r' field or it's not a dictionary");
        return nullptr;
    }
    ...
    auto id = r->getString("id");
    if (!id || id->length() != 20) {
        logger->warning("announce_peer response has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
