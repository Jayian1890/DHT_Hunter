...
std::shared_ptr<QueryMessage> QueryMessage::decode(const bencode::BencodeValue& value) {
    ...
    if (!q) {
        getLogger()->warning("Query has no 'q' field");
        return nullptr;
    }
    // Get transaction ID
    auto t = value.getString("t");
    if (!t) {
        getLogger()->warning("Query has no 't' field");
        return nullptr;
    }
    ...
    auto a = value.get("a");
    if (!a || !a->isDictionary()) {
        getLogger()->warning("Query has no 'a' field or it's not a dictionary");
        return nullptr;
    }
    // Get node ID
    auto id = a->getString("id");
    if (!id || id->length() != 20) {
        getLogger()->warning("Query has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
    NodeID nodeID;
    ...
    switch (method) {
        ...
        default:
            getLogger()->warning("Unknown query method: {}", *q);
            return nullptr;
    }
}
...
std::shared_ptr<PingQuery> PingQuery::decode(const bencode::BencodeValue& value) {
    ...
    auto q = value.getString("q");
    if (!q || *q != "ping") {
        getLogger()->warning("Not a ping query");
        return nullptr;
    }
    // Get transaction ID
    auto t = value.getString("t");
    if (!t) {
        getLogger()->warning("Ping query has no 't' field");
        return nullptr;
    }
    TransactionID transactionID(t->begin(), t->end());
    // Get arguments
    auto a = value.get("a");
    if (!a || !a->isDictionary()) {
        getLogger()->warning("Ping query has no 'a' field or it's not a dictionary");
        return nullptr;
    }
    // Get node ID
    auto id = a->getString("id");
    if (!id || id->length() != 20) {
        getLogger()->warning("Ping query has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
    NodeID nodeID;
    std::copy(id->begin(), id->end(), nodeID.begin());
...
std::shared_ptr<FindNodeQuery> FindNodeQuery::decode(const bencode::BencodeValue& value) {
    ...
    auto q = value.getString("q");
    if (!q || *q != "find_node") {
        getLogger()->warning("Not a find_node query");
        return nullptr;
    }
    // Get transaction ID
    auto t = value.getString("t");
    if (!t) {
        getLogger()->warning("find_node query has no 't' field");
        return nullptr;
    }
    TransactionID transactionID(t->begin(), t->end());
    // Get arguments
    auto a = value.get("a");
    if (!a || !a->isDictionary()) {
        getLogger()->warning("find_node query has no 'a' field or it's not a dictionary");
        return nullptr;
    }
    // Get node ID
    auto id = a->getString("id");
    if (!id || id->length() != 20) {
        getLogger()->warning("find_node query has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
    NodeID nodeID;
    std::copy(id->begin(), id->end(), nodeID.begin());
    ...
    if (!target || target->length() != 20) {
        getLogger()->warning("find_node query has no 'target' field or it's not 20 bytes");
        return nullptr;
    }
    NodeID targetID;
...
std::shared_ptr<GetPeersQuery> GetPeersQuery::decode(const bencode::BencodeValue& value) {
    ...
    auto q = value.getString("q");
    if (!q || *q != "get_peers") {
        getLogger()->warning("Not a get_peers query");
        return nullptr;
    }
    // Get transaction ID
    auto t = value.getString("t");
    if (!t) {
        getLogger()->warning("get_peers query has no 't' field");
        return nullptr;
    }
    TransactionID transactionID(t->begin(), t->end());
    // Get arguments
    auto a = value.get("a");
    if (!a || !a->isDictionary()) {
        getLogger()->warning("get_peers query has no 'a' field or it's not a dictionary");
        return nullptr;
    }
    // Get node ID
    auto id = a->getString("id");
    if (!id || id->length() != 20) {
        getLogger()->warning("get_peers query has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
    NodeID nodeID;
    std::copy(id->begin(), id->end(), nodeID.begin());
    ...
    if (!infoHash || infoHash->length() != 20) {
        getLogger()->warning("get_peers query has no 'info_hash' field or it's not 20 bytes");
        return nullptr;
    }
    InfoHash hash;
...
std::shared_ptr<AnnouncePeerQuery> AnnouncePeerQuery::decode(const bencode::BencodeValue& value) {
    ...
    if (!q || *q != "announce_peer") {
        getLogger()->warning("Not an announce_peer query");
        return nullptr;
    }
    // Get transaction ID
    auto t = value.getString("t");
    if (!t) {
        getLogger()->warning("announce_peer query has no 't' field");
        return nullptr;
    }
    TransactionID transactionID(t->begin(), t->end());
    // Get arguments
    auto a = value.get("a");
    if (!a || !a->isDictionary()) {
        getLogger()->warning("announce_peer query has no 'a' field or it's not a dictionary");
        return nullptr;
    }
    // Get node ID
    auto id = a->getString("id");
    if (!id || id->length() != 20) {
        getLogger()->warning("announce_peer query has no 'id' field or it's not 20 bytes");
        return nullptr;
    }
    NodeID nodeID;
    std::copy(id->begin(), id->end(), nodeID.begin());
    ...
    auto infoHash = a->getString("info_hash");
    if (!infoHash || infoHash->length() != 20) {
        getLogger()->warning("announce_peer query has no 'info_hash' field or it's not 20 bytes");
        return nullptr;
    }
    InfoHash hash;
    std::copy(infoHash->begin(), infoHash->end(), hash.begin());
    ...
    if (!token) {
        getLogger()->warning("announce_peer query has no 'token' field");
        return nullptr;
    }
    ...
    if (!impliedPort) {
        ...
        if (!portValue) {
            getLogger()->warning("announce_peer query has no 'port' field");
            return nullptr;
        }
