...
DEFINE_COMPONENT_LOGGER("Network", "BurstController")
...
BurstController::BurstController(size_t targetRate, size_t maxBurstRate, std::chrono::milliseconds burstDuration)
    ...
    getLogger()->debug("Created BurstController with target rate: {} bytes/sec, max burst rate: {} bytes/sec, burst duration: {} ms",
...
void BurstController::setTargetRate(size_t targetRate) {
    ...
    getLogger()->debug("Target rate updated to {} bytes/sec", targetRate);
}
...
void BurstController::setMaxBurstRate(size_t maxBurstRate) {
    ...
    getLogger()->debug("Max burst rate updated to {} bytes/sec", maxBurstRate);
}
...
void BurstController::setBurstDuration(std::chrono::milliseconds burstDuration) {
    ...
    getLogger()->debug("Burst duration updated to {} ms", burstDuration.count());
}
