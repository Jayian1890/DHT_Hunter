...
DEFINE_COMPONENT_LOGGER("Network", "BufferPool")
...
BufferPool::BufferPool(size_t bufferSize, size_t initialBuffers, size_t maxBuffers)
    ...
    getLogger()->debug("Created buffer pool with buffer size: {}, initial buffers: {}, max buffers: {}",
...
BufferPool::~BufferPool() {
    ...
    getLogger()->debug("Destroyed buffer pool with buffer size: {}, total buffers: {}",
