...
/**
 * @brief Interface for transaction components
 * 
 * This interface defines the common functionality for all transaction components.
 */
...
public:
     ...
     */
    virtual ~TransactionComponent() = default;
