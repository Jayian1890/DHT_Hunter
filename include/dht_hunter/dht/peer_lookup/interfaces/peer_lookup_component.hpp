...
/**
 * @brief Interface for peer lookup components
 * 
 * This interface defines the common functionality for all peer lookup components.
 */
class PeerLookupComponent {
public:
    /**
     * @brief Virtual destructor
     */
    virtual ~PeerLookupComponent() = default;
