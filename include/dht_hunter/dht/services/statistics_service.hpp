...
private:
     ...
     * @param event The event
     */
    void handleNodeAddedEvent(std::shared_ptr<events::DHTEvent> event);
     ...
     * @param event The event
     */
    void handleMessageReceivedEvent(std::shared_ptr<events::DHTEvent> event);
    
    /**
     * @brief Handles a message sent event
     * @param event The event
     */
    void handleMessageSentEvent(std::shared_ptr<events::DHTEvent> event);
