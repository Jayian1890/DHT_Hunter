...
void logFromThread(std::shared_ptr<dl::Logger> logger, int threadId, int numMessages) {
...
int main() {
    ...
    // First, test with synchronous logging
    {
        ...
        dl::Logger::init(dl::LogLevel::INFO, dl::LogLevel::DEBUG, 
                        "sync_logging_demo.log", true, false);
        
        auto logger = dl::Logger::getLogger("SyncDemo");
    ...
    // Now, test with asynchronous logging
    {
        ...
        auto logger = dl::Logger::getLogger("AsyncDemo");
